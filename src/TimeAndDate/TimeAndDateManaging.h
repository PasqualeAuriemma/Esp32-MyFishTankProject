...
// EUROPE/ROME TIMEZONE CET-1CEST,M3.5.0,M10.5.0/3
class TimeAndDate
{
...
public:
  ...
  /**
   * @fn TimeAndDate
   * @brief Costructor of the class when there isn't the connection to WIFI
   */
  TimeAndDate()
  {
    RTC.begin();
  ...
  /**
   * @fn TimeAndDate
   * @brief Costructor of the class when there is the connection to WIFI
   * @param _gmtOffset_sec:  GMT offset (seconds).
   * @param _daylightOffset_sec: Replace with your daylight offset (seconds).
   */
  ...
  void setTimeAndData1(int year, int month, int day, int hour, int min, int sec)
  {
